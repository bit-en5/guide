...
Styles are the conventions that govern our code. The goal of this guide is to define some standard rules in order to make our code simpler to read and to maintain, and so be more productive.

Some conventions covers here are general guidelines for Go, while others extend upon external
resources:
...
All code should be error-free when run through `golint`. We
recommend setting up your editor to:

- Run `golint` to check for errors
